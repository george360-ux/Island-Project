...
<<<<<<< HEAD
Annual tree cover loss (in hectares) was extracted for East and West New Britain from the Global Forest Watch sub national data set. Data were filtered to include only threshold = 0, corresponding to all tree cover regardless of canopy density.
=======
...
>>>>>>> 98af69dd700820d72fdc75000e5dcb3d1aeb90f9
...
<<<<<<< HEAD
saveRDS(nb_all, "nb_all.rds") # This will be used in Shiny App Code
=======
